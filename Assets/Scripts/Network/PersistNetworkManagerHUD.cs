...
public class PersistNetworkManagerHUD : MonoBehaviour
{
    [System.NonSerialized] public NetworkManager manager;
    ...
    void StartButtons()
    {
        if (!NetworkClient.active)
        {
            ...
            if (Application.platform != RuntimePlatform.WebGLPlayer)
            {
                ...
                {
                    (manager as FracturedNetworkManager).StartSinglePlayer();
                }
