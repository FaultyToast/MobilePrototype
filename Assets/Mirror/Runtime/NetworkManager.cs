...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        public void StopClient()
        {
            ...
            // BRYNS EDITS
            // check scene change instead of loadingsceneasync
            if (!string.IsNullOrWhiteSpace(offlineScene) && !IsSceneActive(offlineScene) && !isLoadingScene && !NetworkServer.active)
            {
        ...
        bool InitializeSingleton()
        {
            ...
            // BRYNS EDITS
            // we want to replace the network manager
        ...
        internal void ClientChangeScene(string newSceneName, SceneOperation sceneOperation = SceneOperation.Normal, bool customHandling = false)
        {
            ...
            switch (sceneOperation)
            {
                case SceneOperation.Normal:
                    ClientLoadSceneOperation(newSceneName);
                    break;
        ...
        // BRYNS SLOP
        public virtual void ClientLoadSceneOperation(string newSceneName)
        {
            loadingSceneAsync = SceneManager.LoadSceneAsync(newSceneName);
        }
...
#pragma warning restore 618
        ...
        public virtual void OnPlayerAdded(GameObject player, NetworkConnection conn) { }
